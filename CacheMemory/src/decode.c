...
char	format(int OPCODE)
{
	if (OPCODE == 0x0)
		return ('R');
	else if (OPCODE == 0x4 || OPCODE == 0x5 || (OPCODE >= 0x8 && OPCODE <= 0xd)
		|| OPCODE == 0xf || OPCODE == 0x23 || OPCODE == 0x24
		|| OPCODE == 0x25 || OPCODE == 0x28 || OPCODE == 0x29
		|| OPCODE == 0x2b || OPCODE == 0x30 || OPCODE == 0x38)
		return ('I');
